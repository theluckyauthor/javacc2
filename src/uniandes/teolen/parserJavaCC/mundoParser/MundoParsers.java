...
import uniandes.teolen.parserJavaCC.newParser201820.NuevoParser201820;
...
public class MundoParsers {
	...
	public NuevoParser201820 getNuevoParser201820()
	{
	...
	public String  procesarCadena(String texto) {
		...
		else if(parsers.get(currentParser).equals("NuevoParser201820")){
			NuevoParser201820 nuevoParser = getNuevoParser201820();
			nuevoParser.ReInit(new java.io.StringReader(texto));
			try {
				//TODO
		    int v = nuevoParser.one_line();
